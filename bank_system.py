...
class BankSystem(object):
    ...
    def load_bank_data(self):
        ...
        customer_5 = Customer("Najib", "Arsenal",["123", "Arsenal Street ", "North London", " SE17"])
        account_no+=1
        account_5 = Account(5200.00,account_no)
        ...
        admin_3 = Admin("Luke", "0000", True, ["12", "Calm Street", "West Ham", "E13 3BU"])
    ...
    def run_admin_options(self, admin):
        ...
        while loop == 1:
            ...
            if choice == 1:
                transferMoney = Customer  Account
            elif choice == 2:
                customer_name = input("\nPlease input customer name :\n")
